...
const File_restart:FC = () => {
    ...
    const getcontents = ()=>{
        axios.get(`/api/collection/restart/${id}`)
        .then((res)=>{
            // 获得头以及问题
    ...
    const finish = (values: string)=>{
        ...
        // 修改头部
            ...
            axios.post(`/api/collection/restart/${id}`,{data:JSON.stringify(contents)})
            .then((res)=>{
                // 依据返回的code确定三个状态
